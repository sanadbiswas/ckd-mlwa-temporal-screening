...
style_map = {
    "Raw": {"marker": "o", "linewidth": 2.0, "markersize": 6.5},
    "Sigmoid": {"marker": "o", "linewidth": 2.0, "markersize": 6.5},
    "Isotonic": {"marker": "o", "linewidth": 2.0, "markersize": 6.5}
}
...
for name, p in calibration_candidates.items():
    ...
    style = style_map.get(
        name,
        {"marker": "o", "linewidth": 2.0, "markersize": 6.5}
    )
    ax.plot(
        grouped["mean_pred"],
        grouped["observed"],
...
plt.savefig(
    RESULTS_DIR / "internal_calibration_oof.eps",
    format="eps",
    bbox_inches="tight"
)
plt.savefig(
    RESULTS_DIR / "internal_calibration_oof.svg",
    format="svg",
    bbox_inches="tight"
)
plt.show()
